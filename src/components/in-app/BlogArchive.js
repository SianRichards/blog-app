                    ...
                    return (
                        <div key={blogPost.id} className={styles.post}>
                            <div className="content">
                                ...
                                <div className="header" dangerouslySetInnerHTML={{ __html: blogPost.postTitle }}>
                                </div>
                                <p className="meta">
                                ...
                                <div className="description" dangerouslySetInnerHTML={{ __html: blogPost.postContent }}>
                                </div>
                            </div>
                            <CustomModal />
                            {showMessageIds.includes(blogPost.id) ?
                                ...
                                To cancel this action, click on the 'make public' icon
                                <i className="globe icon"></i> featured on the
                                post again.
                            </div>
                                : null}
                        </div>

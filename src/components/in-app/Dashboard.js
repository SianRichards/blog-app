    ...
    return (
        <div className={styles.dashboard}>
            ...
            <div className={styles.filter}>
                ...
                <i className="filter icon" onClick={() => toggleDisplayFilterMenu(!displayFilterMenu)}></i>
                {displayFilterMenu && <div>
                    <div className="item" onClick={() => filterPosts('most recent')}>Most recent</div>
                    <div className="item" onClick={() => filterPosts('least recent')}>Least recent</div>
                </div>}
            </div>

...
export const deleteBlogPostReducer = (
  state = initialState.deleteBlogPost,
  action
) => {
  switch (action.type) {
...
export const updateBlogPostReducer = (
  state = initialState.updateBlogPost,
  action
) => {
  switch (action.type) {
    case UPDATE_POST:
...
export const editProfileReducer = (
  state = initialState.profileText,
  action
) => {
  switch (action.type) {
    case "EDIT_PROFILE":
...
export const showProfileEditModeReducer = (
  state = initialState.showProfileEditMode,
  action
) => {
  switch (action.type) {
...
export const sendStorageRefReducer = (
  state = initialState.storageRef,
  action
) => {
  switch (action.type) {
